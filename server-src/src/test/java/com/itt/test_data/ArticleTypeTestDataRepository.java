...
@Slf4j
@Configuration
public class ArticleTypeTestDataRepository {
    private static HashMap<String, ArticleType> types;

    public ArticleTypeTestDataRepository() {
    }

    public synchronized HashMap<String, ArticleType> getTypes() {

        if (types == null) {
            types = getTestDataMap(ArticleType.class, "ArticleTypeTestData.json");
        }
        return types;
    }
