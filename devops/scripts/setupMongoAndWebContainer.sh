...
docker build --build-arg tag=$webContainerTag -f devops/dockerFiles/web/dockerfile .
docker build --rm --pull=true --build-arg tag=$webContainerTag -t yashittdocker/adpq-web -f devops/dockerFiles/web/dockerfile .
...
docker build --build-arg tag=$mongoContainerTag -f devops/dockerFiles/mongo/dockerfile .
docker build --rm --pull=true --build-arg tag=$mongoContainerTag -t yashittdocker/adpq-mongo -f devops/dockerFiles/mongo/dockerfile .
